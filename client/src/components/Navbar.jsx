        ...
        <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6' >
            <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24]'>
                <input type="text" placeholder='Search Campaign'
                    className='flex w-full text-[14px] text-white bg-transparent outline-none'
                />
                    ...
                    <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] 
                        ...
                        <ul className='mb-4'>
                            {navlinks.map((Links) => (
                                <li
                                    key={Links.name}  
                                    className={`flex p-4 ${isActive === Links.name
                                        && 'bg-[#3a3a43]' } `}
                                    onClick={() => {
                                ...
                                >
                                  <img 
                                    ...
                                    ${isActive === Links.name && 'grayscale'} `}
                                  />     
                                  <p className={`ml-[20px] font-epilogue font-semibold text-[14px]
                                        ${isActive === Links.name ? 'text-[#1dc071]' : 'text-[#808191]'}  `} >
                                    {Links.name}
                                  </p>     
                                </li>
                            ))}
